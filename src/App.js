...
import Shutout from './component/shutout-list'
  ...
  return (
    <Page>
      ...
      <Price
        ...
        cleaningFee={data.price.cleaning_fee}
        serviceFee={data.price.service_fee}
      ...
      <Contact contact={data.contact_info}></Contact>
      <Additions additions={data.additional_properties} />
      <Shutout list={data.guestReviews} />
      <Places list={data.nearbyAttractions} />
    </Page>
  )
}
